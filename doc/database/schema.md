...
| 15 | `task_templates` | 任务模板 | family_id, name, schedule_type, schedule_data, enabled, kind, branches, location_id, group_id |
| 16 | `todos` | 待办事项 | task_id, family_id, status, branch_name, due_start, due_date, assigned_to, completed_by |
| 17 | `task_logs` | 操作日志 | task_id, status, message, log_type, operator_id |
