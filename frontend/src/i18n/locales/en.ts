export default {
  app: {
    ...
    loadingFamilies: 'Loading families...',    saving: 'Saving...',
    uploading: 'Uploading...',
    creating: 'Creating...',
  ...
  taskCard: {
    ...
    filterArchivedOnly: 'Archived only',
    filterArchivedHide: 'Hide archived',
    filterArchivedUnset: 'No filter (show all)',
    showDisabled: 'Disabled',
    filterDisabledOnly: 'Disabled only',
    filterDisabledHide: 'Hide disabled',
    filterDisabledUnset: 'No filter (show all)',
  },
  taskKind: {
    simple: 'Task',
  ...
  taskForm: {
    ...
    schedule: 'Schedule',
    duration: 'Duration',
    durationHint: 'Due date = trigger time + duration. Falls back to default window if unset.',
    durationPlaceholder: 'Custom, e.g. 2h / 30m / 1h30m',
    durationClear: 'Clear',
    time: 'Time',
    date: 'Date',
    days: 'Days',
  ...
  error: {
    summary: {
      ...
      familyNotFound: 'Family not found or disbanded, please select another family',
