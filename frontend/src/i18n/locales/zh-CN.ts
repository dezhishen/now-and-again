export default {
  app: {
    ...
    fetchingUser: '正在获取用户信息...',
    loadingFamilies: '正在加载家庭列表...',
    saving: '正在保存...',
    uploading: '正在上传...',
    creating: '正在创建...',
    submitting: '正在提交...',
  ...
  taskCard: {
    ...
    noTasks: '暂无任务',
    showArchived: '已归档',
    filterArchivedOnly: '只看已归档',
    filterArchivedHide: '隐藏已归档',
    filterArchivedUnset: '不过滤（显示全部）',
    showDisabled: '已禁用',
    filterDisabledOnly: '只看已禁用',
    filterDisabledHide: '隐藏已禁用',
    filterDisabledUnset: '不过滤（显示全部）',
  },
  taskKind: {
    simple: '任务',
    inspect: '巡检',
  ...
  taskForm: {
    ...
    subTasks: '子任务',
    addSubTask: '添加子任务',
    subTaskName: '子任务名称，如 打扫厨房',
    noSubTasks: '暂无子任务，点击上方按钮添加',
    schedule: '调度',
    duration: '完成时长',
    durationHint: '设置后待办截止时间 = 触发时间 + 时长；不设置则使用默认窗口期',
    durationPlaceholder: '自定义，如 2h / 30m / 1h30m',
    durationClear: '清除',
    time: '时间',
    date: '日期',
    days: '日期',
  ...
  profile: {
    ...
    changePassword: '修改密码', oldPassword: '当前密码', newPassword: '新密码',
    confirmPassword: '确认新密码', passwordMismatch: '两次输入的密码不一致',
    confirmChange: '确认修改', passwordChanged: '密码修改成功',
  },
  error: {
    summary: {
      badRequest: '请求参数有误',
      ...
      forbidden: '没有权限执行此操作',
      notFound: '请求的资源不存在',
      familyNotFound: '家庭不存在或已解散，请重新选择家庭',
      conflict: '数据冲突',
  ...
  admin: {
    heading: '管理面板', users: '用户管理', storage: '系统参数',
    usersDisplayName: '显示名称', usersEmail: '邮箱', usersRoles: '角色', usersCreated: '注册时间',
    actions: '操作', resetPassword: '重置密码',
    searchPlaceholder: '搜索用户名、邮箱...',
    noUsers: '暂无用户', noResults: '未找到匹配的用户',
    showingFrom: '第', showingOf: '条，共',
    resetPasswordTitle: '重置密码',
    resetPasswordConfirm: '确认将用户 {user} 的密码重置为系统默认密码？',
    resetPasswordIs: '新密码',
    resetConfirm: '确认重置',
    resetSuccess: '密码已重置',
    defaultPasswordHeading: '默认密码',
    defaultPasswordDesc: '重置用户密码时使用的默认密码。修改后立即生效，不会影响已有密码。',
    show: '显示', hide: '隐藏',
    regenerate: '重新生成',
  ...
  taskTemplate: {
    ...
    subscription: {
      ...
      name: '名称',
      namePlaceholder: '如：日常模板源',
      autoRefresh: '自动刷新',
      intervalHours: '刷新间隔（小时）',
