...
<template>
  <div class="card hover:shadow-md transition-shadow relative overflow-hidden">
    ...
    <div class="absolute -top-0.5 -right-0.5 w-14 h-14 overflow-hidden z-10">
      <div class="absolute top-2.5 -right-[18px] w-16 bg-purple-500 text-white text-[10px] font-medium text-center leading-4 rotate-45 shadow-sm">{{ t('taskCard.inspectKind') }}</div>
    </div>
